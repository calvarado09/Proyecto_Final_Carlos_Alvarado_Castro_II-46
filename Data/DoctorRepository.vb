...
Public Class DoctorRepository
    ...
    Public Function Insertar(doctor As Doctor) As Boolean
        ...
        Dim query As String = "
            INSERT INTO Doctores (Nombre, Apellido1, Apellido2, Especialidad, Telefono, Email, CodigoColegiado, Cedula)
            VALUES (@Nombre, @Apellido1, @Apellido2, @Especialidad, @Telefono, @Email, @CodigoColegiado, @Cedula)"
    ...
    Public Function Actualizar(doctor As Doctor) As Boolean
        ...
        Dim query As String = "
            UPDATE Doctores
            SET Nombre = @Nombre, Apellido1 = @Apellido1, Apellido2 = @Apellido2, Especialidad = @Especialidad, Telefono = @Telefono, Email = @Email, CodigoColegiado = @CodigoColegiado, Cedula = @Cedula
